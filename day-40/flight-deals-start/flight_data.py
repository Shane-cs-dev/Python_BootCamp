...
class FlightData:
    ...
    def __init__(self, price, departure_airport, arrival_airport, departure_date, return_date, stops):
        self.price = price
...
def get_cheapest_price(data):
    ...
    return_airport = first_flight["itineraries"][0]["segments"][nr_stops]["arrival"]["iataCode"]
    ...
    #
    cheapest_flight = FlightData(lowest_price, departure_airport, return_airport, departure_date, return_date, nr_stops)
    ...
    for flight in data["data"]:
        ...
        if price < lowest_price:
            ...
            return_airport = flight["itineraries"][0]["segments"][nr_stops]["arrival"]["iataCode"]
